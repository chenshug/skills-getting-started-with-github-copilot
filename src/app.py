...
activities = {
    ...
    "Soccer Club": {
        "description": "Casual and competitive soccer sessions for all skill levels",
    ...
    "Art Workshop": {
        ...
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 20,
        "participants": ["harper@mergington.edu", "mia@mergington.edu"]
    },
    # Intellectual activities
    "Debate Team": {
        "description": "Prepare for debates, learn argumentation and public speaking",
    ...
    "Science Club": {
        ...
        "max_participants": 20,
        "participants": ["mia.s@mergington.edu", "ethan@mergington.edu"]
    }
}
